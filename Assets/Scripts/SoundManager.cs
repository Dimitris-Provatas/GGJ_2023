...
public class SoundManager : MonoBehaviour
{
  ...
  [SerializeField] private AudioClip pageOpen;
  [SerializeField] private AudioClip pageClose;
  ...
  public void PlaySoundEffect(string soundEffectName)
  {
    switch (soundEffectName)
    {
      ...
      case "drawOpen":
        ...
        break;
      case "pageOpen":
        soundEffectSource.PlayOneShot(pageOpen);
        break;
      case "pageClose":
        soundEffectSource.PlayOneShot(pageClose);
        break;
      case "easterEgg":
